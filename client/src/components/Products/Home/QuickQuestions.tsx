...
export default function QuickQuestions({ productId }: { productId: number }) {
  ...
  return (
    <div className={"overflow-auto w-full mt-4 mx-10"}>
      ...
      {users && (
        <Avatar.Group count={users.length}>
      ...
      <div
        className={"fixed bg-white w-[86vw] md:w-[64vw] lg:w-[50vw] bottom-0"}
      >
      ...
      <div
        ref={msgListDiv}
        className={`fixed bottom-20 w-full overflow-auto max-h-[86vh] lg:w-[54vw]`}
    ...
    <div className="bg-white  rounded-3xl min-w-[20vw] items-center ">
      <div className="flex items-center">
        ...
        <p className="text-sm text-gray-400 ml-3">
          {moment(new Date(msg.dateSent)).fromNow()}
        </p>
      </div>
      <div>
        <div className="">
